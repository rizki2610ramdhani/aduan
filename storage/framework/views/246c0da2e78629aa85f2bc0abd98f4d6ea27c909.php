					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded30 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								<h2 class="text-primary">Daftar Admin</h2>
								<p class="mb-0">Buat akun baru mu disini.</p>
							</div>
							<div class="p-40">
								<form action="<?php echo e(url('/register-admin')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
								<?php if($errors->any()): ?>
...
<?php echo $__env->make('templates.masyarakat-auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aduannn\resources\views/admin/register.blade.php ENDPATH**/ ?>