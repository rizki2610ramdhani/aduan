		...
		<div class="page-wrapper">
			...
			<nav id="sidebar" class="sidebar-wrapper">
				...
				<div class="sidebar-brand">
					<a href="/admin-dashboard" class="logo">{{Auth::user()->level}}</a>
				</div>
				<!-- Sidebar brand end  -->
				...
				<div class="sidebar-user-details">
					<div class="user-profile">
						<img src="{{ asset('imagesProfile/' . Auth::user()->foto) }}" class="profile-thumb" alt="User Thumb">
						<span class="status-label"></span>
					</div>
					<h6 class="profile-name">{{Auth::user()->nama}}</h6>
				</div>
				<!-- User profile end -->
...
<script src="{{asset('admin/vendor/polyfill/class-list.min.js')}}"></script>

<!-- Apex Charts -->
<script src="{{asset('admin/vendor/apex/apexcharts.min.js')}}"></script>
<script src="{{asset('admin/vendor/apex/custom/home/lineRevenueGradientGraph.js')}}"></script>
<script src="{{asset('admin/vendor/apex/custom/home/radialTasks.js')}}"></script>
<script src="{{asset('admin/vendor/apex/custom/home/lineNewCustomersGradientGraph.js')}}"></script>
